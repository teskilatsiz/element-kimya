                          ...
                          <form className="grid gap-4 py-4">
                            ...
                            <div className="grid grid-cols-4 items-center gap-4">
                              ...
                              <Select defaultValue={selectedProduct.name}>
                                ...
                                <SelectContent>
                                  <SelectItem value={selectedProduct.name}>{selectedProduct.name}</SelectItem>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <h3 className="text-xl font-semibold mb-4">Hızlı Bağlantılar</h3>
              <ul className="space-y-2">
                ...
                <li><button onClick={scrollToUrunlerimiz} className="hover:underline">Ürünlerimiz</button></li>
                <li><Link href="#" className="hover:underline">Hakkımızda</Link></li>
                <li><Link href="#" className="hover:underline">İletişim</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="text-xl font-semibold mb-4">Bizi Takip Edin</h3>
              <div className="flex space-x-4">
                <a href="#" className="hover:text-[#FDF6E9] transition-colors duration-300"><Facebook /></a>
                <a href="#" className="hover:text-[#FDF6E9] transition-colors duration-300"><Twitter /></a>
                <a href="#" className="hover:text-[#FDF6E9] transition-colors duration-300"><Instagram /></a>
                <a href="#" className="hover:text-[#FDF6E9] transition-colors duration-300"><Linkedin /></a>
              </div>
            </div>
          </div>
